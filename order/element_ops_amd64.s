...
// modulus q
DATA q<>+0(SB)/8, $0x2fb2540ec7768ce7
DATA q<>+8(SB)/8, $0xdfbd004dfe0f7999
DATA q<>+16(SB)/8, $0xf05397829cbc14e5
DATA q<>+24(SB)/8, $0x0029cbc14e5e0a72
GLOBL q<>(SB), (RODATA+NOPTR), $32

// qInv0 q'[0]
DATA qInv0<>(SB)/8, $0xe12fe5f079bc3929
...
TEXT ·Butterfly(SB), NOSPLIT, $0-16
	...
	SBBQ    16(DX), R10
	SBBQ    24(DX), R11
	MOVQ    $0x2fb2540ec7768ce7, R12
	MOVQ    $0xdfbd004dfe0f7999, R13
	MOVQ    $0xf05397829cbc14e5, R14
	MOVQ    $0x0029cbc14e5e0a72, R15
	CMOVQCC AX, R12
	CMOVQCC AX, R13
	CMOVQCC AX, R14
	CMOVQCC AX, R15
