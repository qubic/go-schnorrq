	...
	data := []struct {
	...
	}{
		{
			...
			subSeed: [32]byte{
				...
				0x65, 0xcc, 0x38, 0x4f, 0xa, 0x2b, 0x10, 0xce,
		...
		},
		{
			...
			subSeed: [32]byte{
				0x0, 0xac, 0xea, 0xf0, 0x93, 0xfd, 0x94, 0xd8,
				0xce, 0x3b, 0x31, 0x56, 0x96, 0xa3, 0x8e, 0xdf,
				0xb5, 0xd5, 0xc2, 0x47, 0x18, 0x2d, 0xf, 0xd,
				0x3a, 0x97, 0x96, 0xf, 0xc2, 0xa8, 0x29, 0xc7,
			},
		},
		{
			...
			subSeed: [32]byte{
				0x95, 0x1e, 0xe, 0x6c, 0xe0, 0x36, 0x90, 0x76,
				0x1, 0x17, 0xcd, 0x86, 0x2d, 0x2c, 0xe1, 0xa1,
				0x43, 0x4d, 0xee, 0xae, 0xad, 0x37, 0x1e, 0x88,
				0xfe, 0x63, 0xac, 0x8a, 0x29, 0x1f, 0x6c, 0x35,
			},
		},
		{
			name: "TestSign_4_RandomSeed",
			seed: "ddddddddddddddddddddddddddddddddddddddddddddddddddddddd",
			message: [32]byte{
				0x8a, 0x48, 0x1c, 0x7a, 0xe4, 0xa7, 0xc3, 0x3c,
			...
			subSeed: [32]byte{
				0xcb, 0xe4, 0xf4, 0x1a, 0x9c, 0x69, 0xd2, 0x78,
				0x6a, 0x25, 0xb9, 0xde, 0xe8, 0x7c, 0x79, 0x76,
				0x5d, 0xcb, 0xf2, 0xdb, 0x42, 0x6a, 0x3f, 0xd1,
				0x1e, 0x7f, 0x8, 0x97, 0x40, 0xcf, 0x39, 0x36,
			},
		},
	}
