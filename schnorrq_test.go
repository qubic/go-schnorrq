...
var (
	subSeed = [32]byte{
		0x9b, 0x73, 0xbf, 0xc9, 0x50, 0xca, 0x14, 0x79,
		0x59, 0x45, 0x75, 0x63, 0x38, 0xd0, 0x2b, 0xc7,
		0xfa, 0x09, 0xf9, 0x5e, 0xcc, 0xfd, 0x9d, 0x29,
		0x9d, 0xf7, 0xc5, 0x2d, 0xb3, 0xa5, 0x7e, 0xb6,
	}
...
/*func TestSign(t *testing.T) {
	...
	if cmp.Diff(sgn, signature) != "" {
		t.Fatalf("Signature test failure! \nExpected: %s \nGot: 	  %s", hex.EncodeToString(signature[:]), hex.EncodeToString(sgn[:]))
	}
